...
const game: GameState = { mode: 'classic', board: [], score: 12, clearedFruitCount: 12, secondsLeft: 0, nextTickAt: null, status: 'finished', combo: 0, bestCombo: 3, comboDeadline: null, successfulMoves: 4, invalidMoves: 1, hintsUsed: 0, systemReshuffles: 0 }
